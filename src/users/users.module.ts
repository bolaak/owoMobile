...
@Module({
  imports: [MailModule, forwardRef(() => TransactionsModule), forwardRef(() => GrilleTarifaireModule), forwardRef(() => CompteSystemeModule), forwardRef(() => CommissionnementModule), forwardRef(() => AgripayModule),], // Ajoutez MailModule ici
